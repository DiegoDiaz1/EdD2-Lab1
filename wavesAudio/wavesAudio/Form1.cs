    ...
    public partial class Form1 : Form
    {
        ...
        private void button6_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                dicPlaylistQueue.Add(contadorPlaylists + 1, nuevaPlaylist);
            }
        ...
        private void listBox2_Click(object sender, EventArgs e)
        {
            ...
            {
                listBox4.Items.Add(dicPlaylistQueue.ElementAt(listBox2.SelectedIndex).Value.newPlaylist.ElementAt(i).songName.ToString() + "               " + dicPlaylistQueue.ElementAt(listBox2.SelectedIndex).Value.newPlaylist.ElementAt(i).artist.ToString());
            }
        ...
        //Elemento que agreaga canciones a las Listas
        private void listBox3_MouseDoubleClick(object sender, MouseEventArgs e)
        {
            dicPlaylistQueue.ElementAt(listBox2.SelectedIndex).Value.newPlaylist.Add(newWaveList.ElementAt(listBox3.SelectedIndex));
        }

        private void listBox4_DoubleClick(object sender, EventArgs e)
        {
            dicPlaylistQueue.ElementAt(listBox2.SelectedIndex).Value.newPlaylist.RemoveAt(listBox4.SelectedIndex);
        }
